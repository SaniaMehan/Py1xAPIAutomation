...
class TestCreateBooking(object):
    ...
    def test_create_booking_jsonschema(self):
        ...
        print(payload)
        print(type(payload))
        # payload.update({"firstname: "sania","lastname:"mehan}) inbuilt function
        payload["firstname"] = "Sania"
        print(payload)
        ...
        # schema = self.load_schema("C:\Users\admin\PycharmProjects\Py1xAPIAutomation\tests\json_schema\schema.json")
